    ...
    <div style={{
      ...
      <div style={{
        ...
        <form onSubmit={handleLogin}>
          <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: '#7B8499', marginBottom: 6 }}>
            Email
          </label>
          <input
            type="email"
            ...
            style={{
              ...
              border: '1px solid #252B38', background: '#1A1F2A',
              color: '#E8ECF4', fontSize: 14, marginBottom: 16,
          ...
          <input
            ...
            style={{
              width: '100%', padding: '10px 12px', borderRadius: 8,
              border: '1px solid #252B38', background: '#1A1F2A',
              color: '#E8ECF4', fontSize: 14, marginBottom: 20,
              outline: 'none', boxSizing: 'border-box',
            }}
          />
